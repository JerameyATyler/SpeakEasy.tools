...
const useStyles = makeStyles((theme) => ({
    ...
    listItem: {
        ...
        borderBottom: `thin solid ${theme.palette.primary.dark}`,
    },
    listItemIcon: {
            ...
            <div className={clsx(classes.row)}>
                <div className={clsx(classes.pad)}>
                    ...
                    >
                        ...
                        <div className={clsx(classes.pad)}>
                            <Typography>{open ? "Close" : "Open"} Inventory</Typography>
                        </div>
                    </Button>
                    {open && (
                        <List id="inventory-menu" className={clsx(classes.list)}>
                            {inventory &&
                            inventory.map((j, index) => (
                                <ListItem key={index} className={clsx(classes.listItem)}>
                                    <ListItemIcon>
                                        {j.complete ? (
                                            <Check
                                                style={{
